...
const YoES6 = (props: $PostProps) =>
  <Post {...props}>
    <P>
      ...
      <A href="http://yeoman.io" targetBlank>
        Yeoman generator
      </A>. Even it’s not something I write too often, this limitation is quite
      annoying when you actually write it. Here’s the workaround I came up with.
    </P>
    ...
    <Ol>
      ...
      <Li>
        Create generator file within <C>generators/*</C> folder with any name,
        but not <C>index.js</C>. I usually call it <C>index.es6</C>.
      </Li>
      <Li>
        Write your generator in ES6 (see notes below how to make it more
        ES6’ish).
      </Li>
      <Li>
        Setup your Babel environment as usual (install modules, configure{' '}
        <C>.babelrc</C> etc.).
      </Li>
      <Li>Build your generator:</Li>
    </Ol>
    <Snippet lang="bash">
      babel --out-file generators/app/index.js generators/app/index.es6
    </Snippet>
    <P>That’s it. You can use your generator written in ES6.</P>
    ...
    <Ul>
      <Li>
        Use <C>constructor</C> instead of <C>initializing</C> method to attach
        your stuff to the instance.
      </Li>
      <Li>Use class methods to define generator methods.</Li>
      <Li>
    ...
    <P>
      Here is an example of generator written in ES6 and published as npm
      module:{' '}
